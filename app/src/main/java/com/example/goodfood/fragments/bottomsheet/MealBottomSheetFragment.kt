package com.example.goodfood.fragments.bottomsheet
...
import com.example.goodfood.databinding.FragmentMealBottomSheetBinding
...
class MealBottomSheetFragment : BottomSheetDialogFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        onBottomSheetDilogueClick()

    }

    private fun onBottomSheetDilogueClick() {
